---
title: Java项目构建基础 
subtitle: 统一结果，统一异常，统一日志
date: 2022-05-04 20:29:54
banner_img: https://cdn.jsdelivr.net/gh/yingle1991/resources@main/api/blog/tec/index/0505.jpg
tags:
  - 架构
  - 基础
category: 
...
* 第五个属于自定义，前四者可以定义统一的返回对象

###### 注意：
1. 所有的控制器返回只可以调用结果同一类的方法返回结果，不可以直接创建，因此构造器需私有，
2. 内置静态方法，返回结果统一对象；
3. 为了便于自定义结果统一信息，我们可以采用链式编程，将返回对象设类本身，即return this；
4. 相应数据一般为json 格式，可定义为JSONOBject 或者jsonObject对象；
